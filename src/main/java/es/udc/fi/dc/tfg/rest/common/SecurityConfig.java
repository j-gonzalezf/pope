...
public class SecurityConfig {
    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.cors(cors -> cors.disable()).csrf(csrf -> csrf.disable())
                ...
                .requestMatchers(antMatcher("/user-icons/**")).permitAll()
                ...
                .requestMatchers(antMatcher("/api/templates/cycle/{id}/delete")).hasRole("TRAINER")
                .requestMatchers(antMatcher("/api/templates/create")).hasRole("TRAINER")
                .requestMatchers(antMatcher("/api/templates/template/{id}/update")).hasRole("TRAINER")
                .requestMatchers(antMatcher("/api/templates/{id}/delete")).hasRole("TRAINER")
                .requestMatchers(antMatcher("/api/templates/addRow")).hasRole("TRAINER")
                .requestMatchers(antMatcher("/api/templates/templateRow/{id}")).hasRole("TRAINER")
                .requestMatchers(antMatcher("/api/templates/{templateId}/delete/{id}")).hasRole("TRAINER")
                .requestMatchers(antMatcher("/api/exercises/exercise/add")).hasRole("TRAINER")
                .requestMatchers(antMatcher("/api/exercises/{id}/update")).hasRole("TRAINER")
                .requestMatchers(antMatcher("/api/exercises/{id}/delete")).hasRole("TRAINER")
                .requestMatchers(antMatcher("/api/sensations/create")).hasRole("CLIENT")
                .requestMatchers(antMatcher("/api/sensations/{id}/update")).hasRole("CLIENT")
